    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="card">
            <div class="card-body">
              <h3 class="font-weight-bold mb-3">Add Vehicle</h3>
              <form class="forms-sample" method="POST">
                <div class="form-group row">
                  <label class="col-sm-3 col-form-label">Plate Number</label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control" name="id" placeholder="Plate Number">
                  </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" name="merk" placeholder="Vehicle Brand">
                  </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" name="tarif" placeholder="Rent Price">
                  </div>
                </div>
                <div class="form-group row">
                ...
                <button name="submit" class="btn btn-success mr-2">Submit</button>
              ...
              if (isset($_POST['submit'])) {
                ...
                $sql = "INSERT INTO kendaraan (id_kendaraan, jenis_kendaraan, merk_kendaraan, model_kendaraan, tarif, status)
                                VALUES ('$id','$jenis','$merk','$model', '$tarif', '$status')";
