      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
            <div class="content-wrapper">
                <div class="card">
                    <div class="card-body">
                        <h3 class="font-weight-bold mb-3">Add Account</h3>
                        <form class="forms-sample" method="POST">
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">National ID Card</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="nik" placeholder="National ID Card">
                                </div>
                            </div>
                            <div class="form-group row">
                        ...
                        <?php
                            if (isset($_POST['submit'])) {
                                ...
                                $sql = "INSERT INTO akun (id_akun, nama, email, no_telp, username, password, role)
