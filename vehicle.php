          ...
          <div class="card">
            <div class="card-body">
              <div class="d-flex align-items-center justify-content-between pb-2">
                <h3 class="font-weight-bold">Vehicle</h3>
              ...
              <div class="table-responsive">
                <table class="table table-hover">
                  ...
                  <tbody>
                    ...
                    while ($vehicle = mysqli_fetch_assoc($query)) {
                    ?>
                      <tr>
                        <td><?= $no ?></td>
                        <td><?= $vehicle['id_kendaraan'] ?></td>
                        <td><?= $vehicle['jenis_kendaraan'] ?></td>
                        <td><?= $vehicle['merk_kendaraan'] ?></td>
                        <td><?= $vehicle['model_kendaraan'] ?></td>
                        <td><?= $vehicle['tarif'] ?></td>
                        <td><?= $vehicle['status'] == 1 ? "<label class='badge badge-success'>Available</label>" : "<label class='badge badge-danger'>Not Availabe</label>" ?></td>
                        <td>
                          <div class="d-flex">
                            <a href="update_vehicle.php?id=<?= $vehicle['id_kendaraan'] ?>" class="btn btn-warning btn-xs mr-1">Update</a>
                            <button onclick="deleteVehicle('<?= addslashes($vehicle['id_kendaraan']) ?>')" class="btn btn-danger btn-xs ml-1">Delete</button>
                          </div>
                        </td>
                      </tr>
                    <?php
