                    ...
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="password" class="form-control" value="<?= $account['password'] ?>" name="password" placeholder="Password">
                                </div>
                            </div>
                            <div class="form-group row">
                        ...
                        <?php
                            if (isset($_POST['update'])) {
                                ...
                                if(!empty($password)){
                                    $sql = "UPDATE akun SET id_akun='$nik', nama='$nama', no_telp='$telp', email='$email', username='$username', password='$password', role='$role' WHERE id_akun='$_GET[id]'";
